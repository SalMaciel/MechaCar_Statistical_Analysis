...
t.test(susp_table$PSI, mu=mean(susp_table$PSI))
lot1 <- subset(susp_table, Manufacturing_Lot=='Lot1')
t.test(lot1$PSI, mu=mean(susp_table$PSI))
lot2 <- subset(susp_table, Manufacturing_Lot=='Lot2')
t.test(lot2$PSI, mu=mean(susp_table$PSI))
lot3 <- subset(susp_table, Manufacturing_Lot=='Lot3')
t.test(lot3$PSI, mu=mean(susp_table$PSI))